...
* examRecords.teeth.buccal 0..1 BackboneElement "頰側" "頰側牙菌斑"
* examRecords.teeth.buccal.position 1..1 code "位置" "頰側牙菌斑位置"
* examRecords.teeth.buccal.score 1..1 code "註記" "頰側牙菌斑註記" 
* examRecords.teeth.buccal.score from VSPlaqueMark (required)
* examRecords.teeth.palatal 0..1 BackboneElement "腭側" "腭側牙菌斑"
* examRecords.teeth.palatal.position 1..1 code "位置" "腭側牙菌斑位置"
* examRecords.teeth.palatal.score 1..1 code "註記" "腭側牙菌斑註記" 
* examRecords.teeth.palatal.score from VSPlaqueMark (required)
* examRecords.teeth.lingual 0..1 BackboneElement "舌側" "舌側牙菌斑"
* examRecords.teeth.lingual.position 1..1 code "位置" "舌側牙菌斑位置"
* examRecords.teeth.lingual.score 1..1 code "註記" "舌側牙菌斑註記" 
* examRecords.teeth.lingual.score from VSPlaqueMark (required)
